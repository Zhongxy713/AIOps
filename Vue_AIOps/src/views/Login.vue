    ...
    <div style="margin: 200px auto; background-color: #fff; width: 350px; height: 360px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="password">
          <el-input size="medium" style="margin: 10px 0" prefix-icon="el-icon-lock" show-password v-model="user.password" @change="login"></el-input>
        </el-form-item>
        <el-form-item>
          <el-radio v-model="role" label="1" >管理员</el-radio>
          <el-radio v-model="role" label="2" >普通用户</el-radio>
        </el-form-item>
